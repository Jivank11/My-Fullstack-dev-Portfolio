...
function Header() {
  ...
  const handleCopyEmail = async () => {
    try {
      await navigator.clipboard.writeText("jivank1110@gmail.com");
      setIsCopied(true);
      setTimeout(() => {
        setIsCopied(false);
      }, 2000);
    ...
    >
      ...
      >
        ...
        <button
          ...
          onClick={() => {
            const fileName =
              "Jivan_Karlapudi_Fullstack_Resume.pdf";
        ...
        <button
          ...
          data-aos="fade-up"
          onClick={() =>
            window.open("https://www.google.com/maps/search/Pune,%20Maharashtra", "_blank")
          }
        >
          <MapPin className="mr-2" /> {tc("malt")}
        </button>
      </div>
    </div>
  );
